...
import com.example.customperm.command.AliasManager;
...
public class Customperm {
    ...
    private static CommandNode<CommandSourceStack> findRoot(net.minecraft.server.MinecraftServer server, String name) {
