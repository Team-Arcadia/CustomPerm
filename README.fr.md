...
| `/customperm grade parent add <grade> <parent> [durée]` | Fait hériter le grade d'un autre, pour de bon ou pour une durée ; un cycle est refusé. |
| `/customperm grade parent remove <grade> <parent>` | Cesse d'en hériter. |
| `/customperm grade parent adddeny <grade> <parent> [durée]` | Refuse un grade partout où celui-ci en hériterait, pour de bon ou pour une durée. |
...
Ce qui est laissé derrière, et dit dans le rapport plutôt qu'abandonné en silence : les préfixes
temporaires, qui sont posés pour de bon ici ; tout autre contexte (`server=`,
