...
préfixe limités à un monde ; meta, noms affichés, et les nœuds lus par d'autres mods, que plus rien ici ne
lirait. Les raisons sont dans [docs/PLANNED_FEATURES.md](docs/PLANNED_FEATURES.md). Sur les
